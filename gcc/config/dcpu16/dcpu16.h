...
/*
Define this macro to be the number of bits in an addressable storage unit (byte). If
you do not define this macro the default is 8. */
...
#define FIXED_REGISTERS     { 1, 0, 0, \
			      0, 0, 0, \
                              0, 1, 1, 1 }

#define CALL_USED_REGISTERS { 1, 0, 0, \
			      0, 0, 0, \
                              0, 1, 1, 1 }
...
/* A C expression whose value is a register class containing hard
   register REGNO.  */
#define REGNO_REG_CLASS(R) ((R < DCPU_SP) ? GENERAL_REGS : SPECIAL_REGS)
...
#define STACK_POINTER_REGNUM DCPU_SP

/* The register number of the frame pointer register, which is used to
   access automatic variables in the stack frame.  */
#define FRAME_POINTER_REGNUM DCPU_J

/* The register number of the arg pointer register, which is used to
   access the function's argument list.  */
#define ARG_POINTER_REGNUM DCPU_J
...
#define FUNCTION_ARG_REGNO_P(r) (r >= DCPU_A && r <= DCPU_C)
...
#define REGNO_OK_FOR_INDEX_P(NUM) (REGNO_REG_CLASS(NUM) == GENERAL_REGS)
